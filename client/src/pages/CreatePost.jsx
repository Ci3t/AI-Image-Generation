...
const generateImage =async ()=>{
    if(form.prompt){
        try {
            ...
            const response = await fetch('https://dalle-007.onrender.com/api/v1/dalle',{
                method:'POST',
                headers:{
...
const handleSubmit = async(e)=>{
    ...
    if(form.prompt && form.photo){
        ...
        try {
            const response = await fetch('https://dalle-007.onrender.com/api/v1/post',{
                method:'POST',
                headers:{
                    'Content-Type':'application/json'
                },
    ...
    <section className='max-w-7xl mx-auto'>
        ...
        >
            ...
            >
                ...
                handleChange={handleChange}
                isSurpriseMe
                handleIsSurpriseMe={handleSurpriseMe}
                />
                ...
                <div className="relative bg-gray-50 border border-gray-300 text-gray-900 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
                   ...
                   <div className='absolute inset-0 z-0 flex justify-center items-center bg-[rgba(0,0,0,0.5)] rounded-lg'>
                    ...
                    <div className="mt-10">
                        <p className='mt-2 text-[#666e75] text-[14px]'> Create the image and share it with the community </p>
                        <button
                        type='submit'
